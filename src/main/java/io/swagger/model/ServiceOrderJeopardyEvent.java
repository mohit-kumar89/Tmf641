...
import io.swagger.model.ServiceOrderJeopardyEventPayload;
...
public class ServiceOrderJeopardyEvent   {
  @JsonProperty("event")
  private ServiceOrderJeopardyEventPayload event = null;
  ...
  public ServiceOrderJeopardyEvent event(ServiceOrderJeopardyEventPayload event) {
    this.event = event;
    return this;
  }
  ...
  @Schema(description = "")
    ...
    @Valid
    public ServiceOrderJeopardyEventPayload getEvent() {
    return event;
  }

  public void setEvent(ServiceOrderJeopardyEventPayload event) {
    this.event = event;
  }

  public ServiceOrderJeopardyEvent eventId(String eventId) {
  ...
  public ServiceOrderJeopardyEvent eventTime(Date eventTime) {
  ...
  public ServiceOrderJeopardyEvent eventType(String eventType) {
  ...
  public ServiceOrderJeopardyEvent correlationId(String correlationId) {
  ...
  public ServiceOrderJeopardyEvent domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public ServiceOrderJeopardyEvent title(String title) {
    this.title = title;
    return this;
  }
  ...
  public ServiceOrderJeopardyEvent description(String description) {
  ...
  public ServiceOrderJeopardyEvent priority(String priority) {
  ...
  public ServiceOrderJeopardyEvent timeOcurred(Date timeOcurred) {
