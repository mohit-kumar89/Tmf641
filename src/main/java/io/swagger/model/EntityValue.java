 ...
 */
@Schema(description = "Base entity value  schema for use in TMForum Open-APIs")
@Validated
...
public class EntityValue   {
  ...
  public EntityValue _atBaseType(String _atBaseType) {
  ...
  public EntityValue _atSchemaLocation(String _atSchemaLocation) {
  ...
  public EntityValue _atType(String _atType) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, entityValue.id) &&
        ...
        Objects.equals(this._atBaseType, entityValue._atBaseType) &&
        Objects.equals(this._atSchemaLocation, entityValue._atSchemaLocation) &&
        Objects.equals(this._atType, entityValue._atType);
  }
