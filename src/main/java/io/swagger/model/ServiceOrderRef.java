...
public class ServiceOrderRef   {
  ...
  public ServiceOrderRef name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
   **/
  @Schema(description = "Name of the related service order")
  ...
  public ServiceOrderRef _atBaseType(String _atBaseType) {
  ...
  public ServiceOrderRef _atSchemaLocation(String _atSchemaLocation) {
  ...
  public ServiceOrderRef _atType(String _atType) {
  ...
  public ServiceOrderRef _atReferredType(String _atReferredType) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, serviceOrderRef.id) &&
        ...
        Objects.equals(this._atBaseType, serviceOrderRef._atBaseType) &&
        Objects.equals(this._atSchemaLocation, serviceOrderRef._atSchemaLocation) &&
        Objects.equals(this._atType, serviceOrderRef._atType) &&
        Objects.equals(this._atReferredType, serviceOrderRef._atReferredType);
  }
