 ...
 */
@Schema(description = "Related Party reference. A related party defines party or party role linked to a specific entity.")
@Validated
...
public class RelatedParty   {
   ...
   * @return _atType
   **/
  @Schema(required = true, description = "When sub-classing, this defines the sub-class Extensible name")
      @NotNull
