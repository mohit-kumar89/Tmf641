...
public class CancelOrder   {
  ...
  public CancelOrder effectiveCancellationDate(Date effectiveCancellationDate) {
  ...
  public CancelOrder requestedCancellationDate(Date requestedCancellationDate) {
